...
public final class Constants {
     ...
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.43815; //  Measure and set trackwidth
    //public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.43815; //  Measure and set trackwidth
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.59611; //  Measure and set wheelbase
    //public static final double DRIVETRAIN_WHEELBASE_METERS = 0.59611; //  Measure and set wheelbase
 ...
 //   public static final int DRIVETRAIN_PIGEON_ID = 0; //  Set Pigeon ID
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(63.446044921875); // Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(39.111328125); // Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(77.069091796875); // Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(177.099609375); // Measure and set back right steer offset
}
